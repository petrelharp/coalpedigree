...
'''Parameters for migration between expanding populations
   ...
   Run with e.g.
    BFIX=$(printf %05d $RANDOM); time nice -19 python ~/projects/coalpedigree/sim-ibd-pedigree.py -o ${BFIX}-growing-migration-2.fibd.gz -p ${BFIX}-growing-migration-2.pop.gz -l ${BFIX}-growing-migration-2.log -t 150 -i ~/projects/coalpedigree/sim-demographics-2.py &
